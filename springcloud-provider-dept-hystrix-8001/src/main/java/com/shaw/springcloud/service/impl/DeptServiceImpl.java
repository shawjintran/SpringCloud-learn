...
import com.shaw.springcloud.mapper.DeptMapper1;
...
*/
@Service
public class DeptServiceImpl extends ServiceImpl<DeptMapper1, Dept>
	...
	public List<Dept> listall() {
		return deptMapper1.listall();
	}

	@Override
	public Dept get(Long id) {
		return deptMapper1.get(id);
	}
}
